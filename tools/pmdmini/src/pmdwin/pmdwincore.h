...
public:
	/* Exposed for the real-time hardware driver: the PC-98 Timer-B/A
	 * underflow handlers are called once per chip timer tick, exactly as
	 * the original DOS TSR did.  (pc98snd patch.) */
